...
function render() {
  ...
  $("app").innerHTML = `<section class="card"><span class="badge">${esc(p.pattern)}</span><span class="badge">${esc(p.difficulty)}</span><span class="counter">Problem ${current + 1}/75</span>
